  ...
  <main>
    <div class="c-admin">
      ...
      <div class="estudiantes">
        ...
        <h3 style="margin:1em 0; "><?= 'Fecha: ' . date('Y-m-d'); ?></h3>
            ...
            <?php if (!empty($estudiantes)): ?>
              <?php foreach ($estudiantes as $estudiante): ?>
                <tr>
                  ...
                  <td class="td-botones">
                    <button class="btn-asistencia" data-id="<?php echo $estudiante['id']; ?>"
                      data-bloque-id="<?php echo $bloque_id; ?>" data-value="presente">Presente</button>
                  </td>
                  <td class="td-botones">
                    <button class="btn-asistencia" data-id="<?php echo $estudiante['id']; ?>"
                      data-bloque-id="<?php echo $bloque_id; ?>" data-value="falto">Falta</button>
                  </td>
                  <td class="td-botones">
                    <button class="btn-asistencia" data-id="<?php echo $estudiante['id']; ?>"
                      data-bloque-id="<?php echo $bloque_id; ?>" data-value="tardanza">Tardanza</button>
                  </td>
                  <td class="td-botones">
                    <button class="btn-asistencia" data-id="<?php echo $estudiante['id']; ?>"
                      data-bloque-id="<?php echo $bloque_id; ?>" data-value="justificado">Falta Justificada</button>
                  </td>
                </tr>
              <?php endforeach; ?>
            <?php else: ?>
              <tr>
                <td colspan="6">No se encontraron estudiantes para el bloque ID:
                  <?php echo htmlspecialchars($bloque_id); ?>.</td>
              </tr>
            <?php endif; ?>
          </tbody>
        </table>
